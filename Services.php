<?php 
ob_start();
$token = "2145759402:AAEf1Kw4yngQHVzaqFqLp7HNLcljc71A48A"; 
...
طرق الدفع  ( usdt  - اسياسيل - زين كاش )
		...
		'reply_markup'=>json_encode([
		'inline_keyboard'=>[
[['text'=>"اضغط هنا لشراء النقاط",'url'=>'https://t.me/AB_DLLH']],
]
   ])
  ]);
$done["mode"][$from_id] = null;
...
- عذرا عزيزي رصيدك لا يكفي قم بمراسله المطور لشحن رصيدك => [@AB_DLLH]
		',
	]);
$done["mode"][$from_id] = null;
$done = json_encode($done,true);
